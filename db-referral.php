...
<!-- Mirrored from iamubaidah.com/html/oitila/live/db-referral.html by HTTrack Website Copier/3.x [XR&CO'2014], Sun, 06 Nov 2022 22:27:58 GMT -->
                                ...
                                <ul>
                                    ...
                                    <li>
                                        <div class="user-panel">
                                            <span>
                                                <a href="login.php" class="login-btn">Login</a>or</span><a href="register.php"
            ...
            <div class="container">
                ...
                <div class="dashboard-menu">
                    <nav>
                        <ul>
                            ...
                            <li class="nav-item">
                                <a class="nav-link active" href="db-referral.php">Referrals</a>
                            </li>
                            <li class="nav-item">
                ...
                <div class="user-statics">
                    <div class="row">
                        ...
                        <div class="col-xl-3 col-lg-4 col-md-6 col-sm-6">
                            <div class="single-statics refferal-page-static">
                                <div class="part-icon">
                    ...
                    <div class="row">
                        <div class="col-xl-3 col-lg-3 col-sm-6">
                            <div class="single-info">
                                ...
                                <div class="part-text">
                                    ...
                                    <span class="descr">Peredion.com <a href="#" class="mail-icon"><i
                        ...
                        <div class="col-xl-3 col-lg-3 col-sm-6">
                            <div class="single-info">
                                ...
                                <div class="part-text">
                                    ...
                                    <span class="descr">0 + <i class="fas fa-users"></i> 0</span>
                                </div>
                            </div>
                        </div>
                        <div class="col-xl-3 col-lg-3 col-sm-6">
                            <div class="single-info">
                                ...
                                <div class="part-text">
                                    <span class="title">Active Referrals</span>
                                    <span class="descr">0 + <i class="fas fa-users"></i> 0</span>
                                </div>
                            </div>
                        </div>
                        <div class="col-xl-3 col-lg-3 col-sm-6">
                            <div class="single-info">
                                ...
                                <div class="part-text">
                                    <span class="title">Total Ref. Earnings</span>
                                    <span class="descr">$0.00</span>
                                </div>
                            </div>
                        </div>
                    </div>
                ...
                <div class="row">
                    <div class="col-xl-8 col-lg-8 col-md-7">
                        ...
                        <div class="ref-link">
                            <h3 class="title">
                                Refer Friend & Earn $100 Credit
                            </h3>
                            <form>
                                <input type="text" placeholder="https://oitila.template/?refferal=AutWorks2018">
