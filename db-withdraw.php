...
<!-- Mirrored from iamubaidah.com/html/oitila/live/db-withdraw.html by HTTrack Website Copier/3.x [XR&CO'2014], Sun, 06 Nov 2022 22:27:56 GMT -->
                ...
                <div class="dashboard-menu">
                    <nav>
                        <ul>
                            ...
                            <li class="nav-item">
                                <a class="nav-link active" href="db-withdraw.php">Withdraw</a>
                            </li>
                            <li class="nav-item">
                                    ...
                                    <div class="col-xl-6 col-lg-6 col-sm-12">
                                        <div class="oit-width-1">
                                            ...
                                            <form>
                                                ...
                                                <button class="dropdown-toggle displayed-selected-currency"
                                            ...
                                            <div class="dropdown show">
                                                ...
                                                <a class="dropdown-toggle displayed-selected-plan" href="#"
                                                ...
                                                <div class="dropdown-menu plan-select-list"
                                                    aria-labelledby="dropdownMenuLink">
                                                    <a class="dropdown-item single-select-plan selected-plan active"
                                                        href="#">Bitcoin (CryptoCurrency)</a>
                                                    <a class="dropdown-item single-select-plan" href="#">Litecoin
                                                        (CryptoCurrency)</a>
                                                    <a class="dropdown-item single-select-plan" href="#">Dash
                                                        (CryptoCurrency)</a>
                                                    <a class="dropdown-item single-select-plan" href="#">Enjin
                                                        (CryptoCurrency)</a>
                                                    <a class="dropdown-item single-select-plan" href="#">Paypal (Local
                                                        Currency)</a>
                                                    <a class="dropdown-item single-select-plan" href="#">Credit Card
                                                        (Local Currency)</a>
                                                </div>
                                            </div>
                                        ...
                                        <div class="available-balance-el">
                                            ...
                                            <ul>
                                                ...
                                                <li class="pending">
                                                    ...
                                                    <span class="amount">$35.20</span>
                                                </li>
                                            </ul>
                                            <a href="#" class="btn-hyipox-medium withdraw-btn">Let's Withdraw</a>
                                        </div>
                                    </div>
                                </div>
                            </div>
