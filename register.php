                                ...
                                <nav class="navbar navbar-expand-lg">
                                    ...
                                    <div class="collapse navbar-collapse" id="navbarSupportedContent">
                                        <ul class="navbar-nav ml-auto">
                                            ...
                                            <li class="nav-item dropdown show">
                                                <a class="nav-link dropdown-toggle" href="dashboard.php" role="button"
                    ...
                    <form action="includes/formhandler.inc.php" method="post">
                        <div class="row">
                            <div class="col-xl-6 col-lg-6 col-md-6">
                                ...
                                <input type="text" name="referral" placeholder="Choose Your Referral ID(Optional)*">
                            </div>
                            <!-- </div>
                        <div class="term-condition">
                            ...
                            <p>
                                ...
                                commodo consequat ipsum dolor sit
                            ...
                            <div class="row">
                                ...
                                <div class="col-xl-6 col-lg-6">
                                    <button class="def-btn btn-form">Secure Sign Up <i
                ...
                <div class="container">
                    <div class="row justify-content-center">
                        <div class="col-xl-8 col-lg-8">
                            <p>Copyright © <a href="index.html">Defi Trading</a> - 2024. All Rights Reserved</p>
                        </div>
                    </div>
                </div>
            </div>
...
<!-- Mirrored from iamubaidah.com/html/oitila/live/register.html by HTTrack Website Copier/3.x [XR&CO'2014], Sun, 06 Nov 2022 22:28:09 GMT -->
