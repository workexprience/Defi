...
<!-- Mirrored from iamubaidah.com/html/oitila/live/db-history.html by HTTrack Website Copier/3.x [XR&CO'2014], Sun, 06 Nov 2022 22:27:56 GMT -->
...
<body>
    ...
    <div class="mobile-navbar-wrapper">
                                ...
                                <ul>
                                    ...
                                    <li>
                                        <div class="user-panel">
                                            <span>
                                                <a href="#" class="login-btn">Login</a>or</span><a href="#"
        ...
        <div class="user-dashboard">
            <div class="container">
                ...
                <div class="dashboard-menu">
                    <nav>
                        <ul>
                            ...
                            <li class="nav-item">
                                <a class="nav-link active" href="db-history.php">History</a>
                            </li>
                            <li class="nav-item">
                ...
                <h3 class="title">
                    Watch Extreme Recent Transaction
                </h3>
                <div class="history-search-filter">
                    <div class="date-select from-date">
                        <input class="form-control theme_cal_Selected" placeholder="Select Start Date" required
                            data-hint="Please choose a Delivery date" tabindex="20" name="reqDeliveryDate"
                            id="reqDeliveryDate" type="text" data-role="datebox"
                            data-options='{"mode": "calbox", "overrideDateFormat": "%A, %B %-d, %Y", "useClearButton": true, "useCancelButton": true,"popupPosition": "window", "useFocus": true, "calUsePickers":"true", "useInlineBlind":true, "themeDate": "info", "themeDatePick": "danger","useCollapsedBut":true}'>
                    </div>
                    <div class="date-select to-date">
                        <input class="form-control theme_cal_Selected" placeholder="Select End Date" required
                            data-hint="Please choose a Delivery date" tabindex="20" name="reqDeliveryDate"
                            id="reqDeliveryDate2" type="text" data-role="datebox"
                            data-options='{"mode": "calbox", "overrideDateFormat": "%A, %B %-d, %Y", "useClearButton": true, "useCancelButton": true,"popupPosition": "window", "useFocus": true, "calUsePickers":"true", "useInlineBlind":true, "themeDate": "info", "themeDatePick": "danger","useCollapsedBut":true}'>
                    </div>
                    <div class="payment-process">
                        <div class="dropdown">
                            <button class="btn dropdown-toggle" type="button" id="payment-process"
                    ...
                    <div class="transaction-process">
                        <div class="dropdown">
                            <button class="btn dropdown-toggle" type="button" id="transaction-process"
                                data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
    ...
    <script src='../../../../cdn.jsdelivr.net/npm/jtsage-datebox-bootstrap4%405.3.3/jtsage-datebox.min.js'></script>
    <!-- main -->
...
<!-- Mirrored from iamubaidah.com/html/oitila/live/db-history.html by HTTrack Website Copier/3.x [XR&CO'2014], Sun, 06 Nov 2022 22:27:58 GMT -->
